...
REM === Configuration ===
set PROJECT_DIR=C:\Users\picarro\Documents\git\mkndaq
set PYTHON_EXE=%PROJECT_DIR%\.venv\Scripts\python.exe
set SCRIPT_NAME=__fidas-fallback__.py
set SCRIPT=%PROJECT_DIR%\%SCRIPT_NAME%
set LOG_FILE=C:\Users\picarro\Documents\mkndaq\fidas-start.log
