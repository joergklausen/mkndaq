...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e a3peke9ywai7kv-ats.iot.eu-central-1.amazonaws.com -r root-CA.crt -c kenya-mkn-minix.cert.pem -k kenya-mkn-minix.private.key
